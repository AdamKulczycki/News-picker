...
describe('NewsSearchComponent', () => {
  ...
  describe(':', () => {
    ...
    it('should create the NewsSearchComponent', () => {
    ...
    it('form validity', () => {
      ...
      const requireParameters1 =
        component.searchFormSources.controls.parameters;
      ...
      const requireParameters2 =
        component.searchFormCountryCategory.controls.parameters;
    ...
    it('should set params in service', () => {
      ...
      component.searchFormCountryCategory.controls.parameters.controls.country.setValue(
        countryValue
      );
      ...
      component.searchFormSources.controls.parameters.controls.sources.setValue(
        sourcesValue
      );
    ...
    it('should reset the form Country and Category', () => {
      const { fixture, component } = setup();
      fixture.detectChanges();
      component.searchFormCountryCategory.controls.parameters.controls.country.setValue(
        'pl'
      );
      component.resetFormCC();
      fixture.detectChanges();
      const {
        parameters: { country, category, q },
        pageSize
      } = component.searchFormCountryCategory.value;
    ...
    it('should reset the form Sources', () => {
      const { fixture, component } = setup();
      fixture.detectChanges();
      component.switchCountry = false;
      component.searchFormSources.controls.parameters.controls.sources.setValue(
        'bbc-news'
      );
      component.resetFormSources();
      const {
        parameters: { sources, q },
        pageSize
      } = component.searchFormSources.value;
